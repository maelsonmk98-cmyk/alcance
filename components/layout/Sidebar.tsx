...
function SidebarContent({ onNavigate }: SidebarContentProps) {
  ...
  return (
    <>
      {/* Logo */}
      <div className="flex h-[96px] shrink-0 items-center border-b border-white/[0.07] px-6">
        <Link
          href="/dashboard"
          onClick={onNavigate}
          className="flex min-w-0 items-center gap-3"
        >
          <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#F47B20] shadow-[0_6px_18px_rgba(244,123,32,0.25)]">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1.5 whitespace-nowrap text-[8px] font-medium uppercase tracking-[0.15em] text-white/40">
...
export default function Sidebar() {
  ...
  return (
    <>
      {/* =========================================================
          DESKTOP
          Mantém sidebar fixa exatamente no desktop
      ========================================================= */}
      <aside className="hidden h-screen w-[250px] shrink-0 flex-col bg-[#071E49] text-white md:flex">
        <SidebarContent />
      </aside>
      ...
      <div
        ...
        className={[
          "fixed inset-0 z-[70] bg-black/60 backdrop-blur-[2px] transition-opacity duration-300 md:hidden",
          mobileOpen
      ...
      <aside
        className={[
          "fixed inset-y-0 left-0 z-[80] flex w-[285px] max-w-[86vw] flex-col bg-[#071E49] text-white shadow-[20px_0_60px_rgba(0,0,0,0.35)] transition-transform duration-300 ease-out md:hidden",
